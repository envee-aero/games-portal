...
window.hideAd = function(){		
	...
	$('#c2canvasdiv').css({'display':'inline'});
};
...
window.showNewAd = function(enforce=false){
	...
	if(window.adShowCount>0 && ((window.adShowCount%window.callTimesPerAdShow)!=0)){
		...
		if(!enforce)
			...
			window.adShowCount=window.callTimesPerAdShow;
